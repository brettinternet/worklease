...
- [ ] #2 Default headings and boolean values use concise human-readable wording and the table remains legible on an 80-column terminal for bundled policies.
...
- [ ] #6 CLI contract tests cover compact, full, empty, external-policy, and JSON behavior; command help and human-readable output documentation are updated.
<!-- AC:END -->
