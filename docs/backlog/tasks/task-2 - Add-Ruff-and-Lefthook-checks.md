...
<!-- SECTION:PLAN:BEGIN -->
1. Inspect repository Python, mise, and hook conventions plus installed tool versions. 2. Add Ruff config and mise tasks for check/format, add Lefthook config and mise bootstrap task for staged Python checks. 3. Update AGENTS.md with mandatory fix-and-verify guidance. 4. Run targeted Ruff, Lefthook, and mise checks, finalize task evidence, and commit all changes.
<!-- SECTION:PLAN:END -->
