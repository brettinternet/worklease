...
func newCommands(s *boundary) []*urfavecli.Command {
	...
	queueBrowse.Commands = []*urfavecli.Command{queueInitCommand(s), queueQuery, queueNext, queueRecoveryCommand(s), queueIdentityCommand(s), queueAuthorityIDCommand(s), queueAdapterApprovalCommand(s)}
