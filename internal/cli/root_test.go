...
func TestCanonicalCommandHelpPathsFlagsAndExamples(t *testing.T) {
	...
	tests := []canonicalHelpCase{
		...
		{path: "instructions setup", example: "worklease instructions setup", flags: []string{}},
		{path: "instructions remote", example: "worklease instructions remote", flags: []string{}},
		{path: "instructions server", example: "worklease instructions server", flags: []string{}},
		...
		{path: "server reset", example: "worklease server reset --home DIR --confirm-reset", flags: []string{"server-config", "bootstrap-invite-file", "confirm-reset", "force", "unresolved-export"}},
