...
var topics = map[string][]string{
	...
	"loop": {
		...
		"2. Acquire immediately after choosing a candidate, before reading its full intent, planning, delegation, or edits; the CLI uses a private contextual handle by default. Skip candidates that worklease status already shows as claimed. In a loop, on conflict do not wait: select the next ready candidate. Hold at most one claim while selecting.",
