...
BENCHMARKS = (
    ...
    ("./internal/queueui", "BenchmarkQueuePreparedRefreshToRender/items-10000$"),
    ("./internal/queueui", "BenchmarkQueuePreparedRefreshToRender/items-50000$"),
    ("./internal/queueui", "BenchmarkQueuePreparedRefreshToRender/items-100000$"),
    ("./internal/queueui", "BenchmarkQueuePreparedConfiguredRefreshToRender/items-10000$"),
    ("./internal/queueui", "BenchmarkQueuePreparedConfiguredRefreshToRender/items-50000$"),
    ("./internal/queueui", "BenchmarkQueuePreparedConfiguredRefreshToRender/items-100000$"),
